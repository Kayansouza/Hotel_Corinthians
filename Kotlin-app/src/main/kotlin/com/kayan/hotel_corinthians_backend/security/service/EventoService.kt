...
@Service // Essencial para o Spring Boot reconhecer a classe
class EventoService {

    fun calcularGarcons(conv: Int, dur: Int): Int =
        ceil(conv / 12.0).toInt() + floor(dur / 2.0).toInt()
    ...
    fun calcularCusto(garcons: Int, dur: Int, cafe: Double, agua: Double, salgados: Int): Double {
        // Cálculo do custo total baseado em horas de serviço e insumos
